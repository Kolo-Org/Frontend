...
describe('BalanceCard', () => {
  ...
  it('renders balance and trend data correctly', () => {
    render(<BalanceCard balance={12450} currency="USDC" trendPercentage={2.4} isLoading={false} />);
  ...
  it('handles negative trends correctly', () => {
    render(<BalanceCard balance={100} currency="USDC" trendPercentage={-1.5} isLoading={false} />);
